...
class OrderGoodsDetail:
    ...
    def execute_to(self,type):
        ...
        try:
            ...
            receivers = ['cykj@cook2ez.com','linlihong@cook2ez.com','xuboer@cook2ez.com','linyifan@cook2ez.com']
            cc = ['']
