				...
				<div class="form-wrap">
					<div class="form-item-wrap">
        				<el-form-item label="用户">
        					<div class="form-item-inner-text">{{frame_user}}</div>
                      	</el-form-item>
        				<el-form-item prop="old_password" label="旧密码">
                        	<el-input v-model="form.old_password" type='password' :maxlength='maxLength'></el-input>
                      	</el-form-item>
                      	<el-form-item prop="new_password" label="新密码">
                        	<el-input v-model="form.new_password" type='password' :maxlength='maxLength'></el-input>
                      	</el-form-item>
                      	<el-form-item prop="comfirm_password" label="确认密码">
                        	<el-input v-model="form.comfirm_password" type='password' :maxlength='maxLength'></el-input>
                      	</el-form-item>
                  	</div>
              	</div>
...
Vue.$page.mixin.push({
	data:function(){
		...
		var data = {
			...
			maxLength:<?=SystemUser::PASSWORD_MAX_LENGTH ?>,
			rules:{
				  'old_password': [
	...
	methods:{
		onSubmit:function(){
			var _this = this;
			this.$refs['form'].submit('<?=Url::toRoute() ?>',{
				before:function(){
